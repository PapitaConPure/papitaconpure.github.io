...
import { faCheck, faClock, faDownload, faExternalLinkAlt, faEye, faSpinner } from '@fortawesome/free-solid-svg-icons';
...
function AssetDownloadsSection({ item, lang, t }: Readonly<AssetDownloadsSectionProps>) {
...
export default AssetDownloadsSection;
